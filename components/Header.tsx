...
const Header = () => {
  return (
    <div className="flex flex-col">
      ...
      <header className="md:hidden flex justify-between items-center p-4 bg-[#333333] text-white">
      ...
      <header className="hidden md:flex justify-between items-center p-4 bg-[#333333] text-white">
        <div className="flex items-center">
